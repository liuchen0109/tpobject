...
<!-- top部分DIV -->
    ...
    <!--主体登录部分-->
	<div id="banner">
		 <form id="LoginForm" action="CustomerIndex.html" method="post">
     <table width="565" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td><input name="userId" type="text" class="la" id="userId" /></td>
         <td></td>
       </tr>
       <tr>
         <td></td>
       ...
       <tr>
         <td></td>
         <td class="ld"></td>
        <td class="button"><a href="Customer.html">
           <img src="/TP/test/Public/images/button.gif" width="170" height="29" alt="登录" />
         </a></td>
         <td></td>
       </tr>
     </table>
